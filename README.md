...
[![Version](https://img.shields.io/badge/version-0.0.9-blue)](CHANGELOG.md)
...
| Authentication | Optional API-wide Bearer boundary with distinct operator and approver roles |
