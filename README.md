...
[![Version](https://img.shields.io/badge/version-0.0.14-blue)](CHANGELOG.md)
...
> [!IMPORTANT]
> **Pre-alpha status:** Phase 0.0.14 includes one opt-in, scope-checked passive URL
...
| Execution | Opt-in DNS-pinned passive GET capture plus a durable Worker boundary and orphan-resource cleanup contract; arbitrary tools and exploit execution remain disabled |
...
evidence review, immutable Markdown/JSON report exports, and a tested orphan-runtime
cleanup contract. A concrete restricted runtime and startup integration remain before
