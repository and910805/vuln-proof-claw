...
from vuln_proof_claw.api.routes.automation import router as automation_router
...
def create_app(
    ...
    *,
    ...
    app.include_router(automation_router, prefix="/api/v1", dependencies=protected)
